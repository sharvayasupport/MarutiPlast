...
if('ConsultStreet' == $activate_theme || 'FitnessBase' == $activate_theme || 'AssentPress' == $activate_theme || 'Beauty Spa Salon' == $activate_theme || 'Decorexo' == $activate_theme || 'EnvoPress' == $activate_theme || 'EarnPress' == $activate_theme){		$text_align = 'center';	
}
...
<section class="theme-block theme-services <?php if('FitnessBase' == $activate_theme){ echo 'theme-bg-gradient-bg'; }?><?php if('EnvoPress' == $activate_theme){echo 'vrsn-three';}?>" id="theme-services">
	...
	<div class="row theme-services-content">
		...
		foreach ( $consultstreet_service_content as $features_item ) {
			...
			{ 
		        if('ConsultStreet' == $activate_theme || 'AssentPress' == $activate_theme || 'EarnPress' == $activate_theme){
