...
<!-- Theme info Area -->
<section class="theme-info-area <?php if('Interior Dark' == $activate_theme || 'InteriorX' == $activate_theme || 'Interior Decor' == $activate_theme){ echo 'vrsn-two'; } ?>" id="theme-info-area">
<div class="container" >
	<div class="row">
				<?php 
				...
				?>
						<div class="col-lg-<?php if('Designexo' == $activate_theme || 'InteriorWP' == $activate_theme || 'Designexo Child Theme' == $activate_theme || 'Architects' == $activate_theme || 'Interior Dark' == $activate_theme || 'InteriorX' == $activate_theme ){ echo '3'; } ?><?php if('Empresa' == $activate_theme || 'Technoex' == $activate_theme || 'Interior Decor' == $activate_theme){ echo '4'; } ?> col-md-6 col-xs-12">
