...
if('Designexo' == $activate_theme || 'InteriorWP' == $activate_theme || 'Designexo Child Theme' == $activate_theme || 'Architect Decor' == $activate_theme || 'Architects' == $activate_theme || 'IntecoPress' == $activate_theme || 'Interior Dark' == $activate_theme || 'InteriorX' == $activate_theme){
...
if($designexo_project_disabled == true): ?>
	<section class="theme-block theme-project theme-bg-grey pb-0 <?php if('Interior Dark' == $activate_theme || 'Interior Decor' == $activate_theme){ echo 'vrsn-three'; } ?>" id="theme-project">
