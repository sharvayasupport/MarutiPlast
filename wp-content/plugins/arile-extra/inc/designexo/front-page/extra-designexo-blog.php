...
if($designexo_blog_disabled == true): ?>
	<section class="theme-block theme-blog <?php if($activate_theme == 'IntecoPress'){ echo 'list-view-news';} ?> theme-bg-grey <?php if('Interior Dark' == $activate_theme || 'Interior Decor' == $activate_theme){ echo 'vrsn-three'; } ?>" id="theme-blog">
