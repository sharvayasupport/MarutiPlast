		...
		<?php 
			...
			<?php if($title != '' || $img_description!= '' || $readmore_button!=''){ ?>
				<div class="container theme-slider-content">
					<div class="theme-text-<?php if('Designexo' == $activate_theme || 'Designexo Child Theme' == $activate_theme || 'Architect Decor' == $activate_theme || 'Interior Dark' == $activate_theme || 'Interior Decor' == $activate_theme){ echo 'left'; } ?><?php if('Empresa' == $activate_theme || 'InteriorWP' == $activate_theme || 'Architects' == $activate_theme || 'Monster Dark' == $activate_theme || 'NewsMedia' == $activate_theme || 'SpiceMag' == $activate_theme || 'DesignTech' == $activate_theme || 'InteriorX' == $activate_theme || 'Technoex' == $activate_theme || 'Atlanta Blog' == $activate_theme){ echo 'center'; } ?> theme-caption-bg<?php if('Empresa' == $activate_theme || 'Architects' == $activate_theme || 'SpiceMag' == $activate_theme || 'InteriorX' == $activate_theme || 'Technoex' == $activate_theme){ echo '2'; } ?> <?php if('InteriorWP' == $activate_theme || 'Monster Dark' == $activate_theme || 'NewsMedia' == $activate_theme || 'DesignTech' == $activate_theme || 'Atlanta Blog' == $activate_theme){ echo 'align-center';} ?>">
					<?php if($subtitle != ''){ ?>
