...
if($arilewp_blog_disabled == true): ?>
	<section class="theme-block theme-blog <?php if($activate_theme == 'Business Street' || $activate_theme == 'InteriorPress' || $activate_theme == 'InnoPress') { echo 'list-view-news'; } ?>" id="theme-blog">
	 <?php if($arilewp_blog_area_title != null || $arilewp_blog_area_des != null): ?>
        ...
        $post_args = array( 'post_type' => 'post', 'category__in' => $arilewp_theme_blog_category, 'post__not_in'=>get_option("sticky_posts")) ;
			...
			{	
				...
				{ ?>
					<div class="col-lg-<?php if($activate_theme == 'Business Street' || $activate_theme == 'InteriorPress' || $activate_theme == 'InnoPress') { echo '6'; } elseif($activate_theme == 'Architect Design' || $activate_theme == 'Ariletech' || $activate_theme == 'DesignHub' || $activate_theme == 'Alberta' || $activate_theme == 'Agency Street' || 'Etowah' == $activate_theme) { echo '4'; } else { echo '3';}   ?> col-md-6 col-sm-12">
						<article class="post <?php if($activate_theme == 'Business Street' || $activate_theme == 'InteriorPress' || $activate_theme == 'InnoPress') { echo 'media'; } ?>">
						...
						<?php endif; ?>	
							<div class="<?php if($activate_theme == 'Business Street' || $activate_theme == 'InteriorPress' || $activate_theme == 'InnoPress') { echo 'media-body'; } ?> post-content">
							...
							<?php if($activate_theme == 'Business Street' || $activate_theme == 'InteriorPress' || $activate_theme == 'InnoPress') {	?>
							<?php if($arilewp_home_blog_meta_disabled == true): ?>
								<div class="entry-meta">
									<span class="author">
