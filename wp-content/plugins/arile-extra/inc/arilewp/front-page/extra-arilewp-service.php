	...
	<div class="row theme-services-content">
		...
		foreach ( $arilewp_service_content as $features_item ) {
			...
			<div class="col-lg-4 col-md-6 col-sm-12">				
					...
					<article class="<?php if($activate_theme != 'Business Street' && $activate_theme != 'DesignHub' && $activate_theme != 'Agency Street'){echo 'service-content text-center';}else{echo 'service-content-two media';} ?>">
					
					<?php if($features_item->choice == 'customizer_repeater_image'){ ?>
							<?php if ( ! empty( $image ) ) : ?>
							<figure class="service-content-thumbnail<?php if($activate_theme == 'Business Street' || $activate_theme == 'DesignHub' || $activate_theme == 'Agency Street'){echo '-two';} ?>">
								<?php if ( ! empty( $link ) ) : ?>
						...
						<?php if($activate_theme == 'Business Street' || $activate_theme == 'DesignHub' || $activate_theme == 'Agency Street'){echo '<div class="media-body">';} ?>
							<?php if ( ! empty( $title ) ) : 
								if(empty($link)){ ?>
						...
						<?php if($activate_theme == 'Business Street' || $activate_theme == 'DesignHub' || $activate_theme == 'Agency Street'){echo '</div>';} ?>
