			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<?php if($arilewp_project_area_title != null): ?>
						<p class="theme-section-subtitle <?php if($activate_theme == 'Business Street' || $activate_theme == 'Alberta' || 'InnoPress' == $activate_theme || 'Agency Street' == $activate_theme || 'Etowah' == $activate_theme) { echo 'text-light'; } ?>"><?php echo wp_kses_post($arilewp_project_area_title); ?></p>
					<?php endif; ?>
					<?php if($arilewp_project_area_des != null): ?>
						<h2 class="theme-section-title <?php if($activate_theme == 'Business Street' || $activate_theme == 'Alberta' || 'InnoPress' == $activate_theme || 'Agency Street' == $activate_theme || 'Etowah' == $activate_theme) { echo 'text-light'; } ?>"><?php echo wp_kses_post($arilewp_project_area_des); ?></h2>
					<?php endif; ?>
