...
?>
<section class="theme-block theme-testimonial <?php if($activate_theme == 'Business Street' || $activate_theme == 'InteriorPress' || $activate_theme == 'Ariletech' || 'DecorPress' == $activate_theme || $activate_theme == 'Alberta' || $activate_theme == 'Architecto' || $activate_theme == 'Agency Street' || 'Etowah' == $activate_theme) { echo 'vrsn-two theme-bg-default'; } ?>" id="theme-testimonial">
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<?php if($arilewp_testimonial_area_title != null): ?>
						<p class="theme-section-subtitle  <?php if($activate_theme == 'Business Street' || $activate_theme == 'StrangerWP' || $activate_theme == 'InteriorPress' || $activate_theme == 'Ariletech' || 'DecorPress' == $activate_theme || $activate_theme == 'Alberta' || $activate_theme == 'Architecto' || $activate_theme == 'InnoPress' || $activate_theme == 'Agency Street' || 'Etowah' == $activate_theme) { echo 'text-light'; } ?>"><?php echo wp_kses_post($arilewp_testimonial_area_title); ?></p>
					<?php endif; ?>
					<?php if($arilewp_testimonial_area_des != null): ?>
						<h2 class="theme-section-title <?php if($activate_theme == 'Business Street' || $activate_theme == 'StrangerWP' || $activate_theme == 'InteriorPress' || $activate_theme == 'Ariletech' || 'DecorPress' == $activate_theme || $activate_theme == 'Alberta' || $activate_theme == 'Architecto' || $activate_theme == 'InnoPress' || $activate_theme == 'Agency Street' || 'Etowah' == $activate_theme) { echo 'text-light'; } ?>"><?php echo wp_kses_post($arilewp_testimonial_area_des); ?></h2>
					<?php endif; ?>
						<div class="theme-separator-line-horrizontal-full <?php if($activate_theme == 'Business Street' || $activate_theme == 'Ariletech' || $activate_theme == 'Alberta' || $activate_theme == 'InnoPress' || $activate_theme == 'Agency Street' || 'Etowah' == $activate_theme) { echo 'theme-bg-light'; } ?>"></div>
					</div>
				</div>
			</div>
	    <?php endif; ?>
			...
			$allowed_html = array('br' => array(), 'em' => array(), 'strong' => array(), 'b' => array(),'i' => array());
					...
					?>
						...
						<?php if($activate_theme == 'Business Street' || $activate_theme == 'InteriorPress' || $activate_theme == 'Ariletech' || 'DecorPress' == $activate_theme || $activate_theme == 'Alberta' || $activate_theme == 'Architecto' || $activate_theme == 'InnoPress' || $activate_theme == 'Agency Street' || 'Etowah' == $activate_theme) {?>
