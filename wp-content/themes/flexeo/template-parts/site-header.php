		...
		<div class="dt_header-navwrapper">
			<div class="dt_header-navwrapperinner">
				...
				<div class="dt_navbar dt-d-none dt-d-lg-block">
					<div class="dt_navbar-wrapper <?php if($atua_hs_hdr_sticky=='1'): esc_attr_e('is--sticky','flexeo'); endif; ?>">
						<div class="dt-container">
							<div class="dt-row">
								<div class="dt-col-12">
				...
				<div class="dt_mobilenav <?php if($atua_hs_hdr_sticky=='1'): esc_attr_e('is--sticky','flexeo'); endif; ?> dt-d-lg-none">
