...
class Welding_Work_Loader {
	 ...
	 * @return void
	 */
	public function welding_work_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function welding_work_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function welding_work_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function welding_work_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->welding_work_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function welding_work_load( $class ) {
