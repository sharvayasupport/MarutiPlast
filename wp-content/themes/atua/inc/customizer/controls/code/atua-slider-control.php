 ...
 * @access public
 */
class Atua_Customizer_Range_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script(
			'atua-controls',
			ATUA_THEME_INC_URI . '/customizer/controls/js/controls.js',
			array(
				'jquery',
				'customize-base',
				'jquery-ui-button',
		...
		wp_enqueue_style( 'atua-controls', ATUA_THEME_INC_URI . '/customizer/controls/css/controls.css' );
		wp_enqueue_style( 'font-awesome', ATUA_THEME_URI . '/assets/vendors/css/all.css' );
	}
	
	/**
	 * Atua_Customizer_Range_Control constructor.
	 *
 ...
 */
function atua_sanitize_range_value( $input ) {
	if ( atua_is_json( $input ) ) {
